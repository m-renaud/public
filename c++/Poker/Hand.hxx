...
// No Hand < defined here so will use default above
// No Hand == defined here so will use default above
...
/*
  Default code here. So, you can delete this because it will pick up
  Hand_Impl's definition of these... (I didn't "fix" anything here.)
